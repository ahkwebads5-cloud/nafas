...
var DOCLABEL = { readiness:'ملف الجاهزية للتمويل', feasibility:'دراسة الجدوى', deck:'العرض التقديمي للمستثمرين', emails:'حزمة التواصل مع المستثمرين', captable:'هيكل الملكية', turnaround:'خطة إنقاذ المشروع المتعثّر' };
...
var SECTIONS = {
  ...
  emails: [
    { title:'المستثمرون المناسبون وبيانات التواصل', search:true, task:'ابحث وأدرج قائمة بأسماء حقيقية للمستثمرين/الجهات المناسبة لقطاع ومرحلة المشروع في بلده، في جدول يشمل: (الاسم، النوع، ما يهتمون به، مرحلتهم المفضّلة، البريد الإلكتروني الرسمي إن كان متاحاً من مصدر عام + رابط صفحة التقديم/التواصل الرسمية). استعن بالبحث للحصول على بيانات تواصل حقيقية؛ وإن لم يتوفر بريد عام موثوق فاذكر القناة الرسمية للتقديم (نموذج/موقع) بدلاً من تخمين بريد. نبّه أن البيانات من مصادر عامة ويُفضّل التأكد منها قبل التواصل.' },
  ...
  turnaround: [
    { title:'تشخيص التعثّر', task:'حلّل بعمق أسباب التعثّر (مالية/إدارية/تشغيلية/سوقية) اعتماداً على وضع المشروع وإجابات صاحبه. فرّق بين الأعراض والجذور الحقيقية للمشكلة، ورتّب الأسباب حسب خطورتها في جدول (السبب، الأثر، مدى الإلحاح).' },
    { title:'المعالجة المالية', chart:true, task:'خطة معالجة مالية عملية: إدارة السيولة والتدفق النقدي، إعادة هيكلة المصاريف (فصل الثابت عن المتغيّر وخفض ما يمكن)، التعامل مع الديون والمستحقات المتأخرة، وترتيب أولويات الصرف. أضف جدولاً ورسماً بيانياً لتحسّن الكاش المتوقع بعد المعالجة.' },
    { title:'المعالجة الإدارية والتشغيلية', task:'معالجة الخلل الإداري والتشغيلي: إعادة ترتيب الهيكل والمسؤوليات، رفع الكفاءة التشغيلية، إعادة التركيز على المنتج/العميل الأعلى ربحية، وإيقاف الأنشطة الخاسرة. قدّم توصيات محددة قابلة للتنفيذ.' },
    { title:'خطة الإنقاذ (90 يوماً)', task:'خطة إنقاذ عملية لـ90 يوماً بأولويات أسبوعية وشهرية، ومؤشرات نجاح واضحة لكل مرحلة، وأصعب القرارات المطلوبة (وتوقيتها)، ومتى يُعتبر المشروع قد تعافى وخرج من منطقة الخطر.' }
  ]
};
