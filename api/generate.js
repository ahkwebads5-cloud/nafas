...
function cur(d){ return CURSYM[d.currency] || 'ج.م'; }
...
function ctx(d){
  ...
  return 'بيانات المشروع:\n' +
    ...
    '- المرحلة: ' + (d.stage || '') + '\n' +
    '- البلد: ' + (d.country || '') + '\n' +
    '- العملة المستخدمة: ' + c + ' (استخدمها في كل الأرقام المالية)\n' +
    ...
    '- المبلغ المطلوب تجميعه: ' + num(d.needed) + ' ' + c + '\n';
}
...
var SEARCH_NOTE = ' مهم جداً للمصداقية: استخدم أداة البحث في الويب للحصول على أرقام وإحصائيات حقيقية حديثة. بعد كل رقم مهم اذكر المصدر (اسم الجهة + السنة + رابط المصدر). لا تذكر أي رقم لم تجده فعلاً في نتائج البحث، وإذا لم تجد رقماً موثوقاً فقل ذلك صراحة بدل التخمين. فضّل المصادر الرسمية (أجهزة الإحصاء، البنك الدولي، تقارير القطاع، Statista). في نهاية القسم أضف سطراً: «تُنصح مراجعة الأرقام من مصادرها الأصلية قبل الاعتماد النهائي».';
var CHART_NOTE = ' أدرج رسم <svg> إنلاين بسيط (أعمدة أو خطوط، عرض 100%، ارتفاع ~220، لون أخضر #0e9f6e) يوضّح الأرقام الأساسية.';

var DOCLABEL = { readiness:'ملف الجاهزية للتمويل', feasibility:'دراسة الجدوى', deck:'العرض التقديمي للمستثمرين', emails:'حزمة التواصل مع المستثمرين', captable:'هيكل الملكية', turnaround:'خطة إنقاذ المشروع المتعثّر', bizplan:'خطة العمل (Business Plan)', market:'دراسة السوق' };
...
var SECTIONS = {
  ...
  bizplan: [
    { title:'الملخص التنفيذي ووصف الشركة', task:'ملخص تنفيذي احترافي جذّاب، ثم وصف الشركة: الرؤية، الرسالة، القيمة المقدَّمة، الشكل القانوني والمرحلة.' },
    { title:'المنتجات/الخدمات ونموذج العمل', task:'وصف تفصيلي للمنتجات/الخدمات، مشكلة العميل التي تُحل، والميزة، ونموذج العمل ومصادر الإيراد بوضوح.' },
    { title:'تحليل السوق', search:true, task:'تحليل سوق معمّق بأرقام حقيقية موثّقة: حجم السوق (TAM/SAM/SOM)، معدل النمو، شرائح العملاء، والاتجاهات، مع المصادر والروابط.' },
    { title:'استراتيجية التسويق والمبيعات', task:'استراتيجية تسويق ومبيعات عملية: التموضع، قنوات الوصول، تكلفة اكتساب العميل المتوقعة، وخطة النمو والتسعير.' },
    { title:'الخطة التشغيلية والإدارية', task:'الخطة التشغيلية (العمليات، الموردون، الموارد)، والهيكل الإداري والفريق [placeholder للأسماء]، وأهم المخاطر التشغيلية.' },
    { title:'الخطة المالية وطلب التمويل', chart:true, task:'خطة مالية: اقتصاديات الوحدة، جدول توقعات 3 سنوات (إيراد/مصاريف/ربح) مبني على أرقام المشروع، نقطة التعادل، رسم بياني، ثم مبلغ التمويل المطلوب وأوجه استخدامه.' }
  ],
  market: [
    { title:'حجم السوق واتجاهاته', search:true, chart:true, task:'حجم السوق المستهدف في بلد المشروع (TAM/SAM/SOM) بأرقام حقيقية موثّقة ومصادر وروابط، ومعدلات النمو والاتجاهات الرئيسية، مع رسم بياني.' },
    { title:'تحليل شرائح العملاء', search:true, task:'تحليل شرائح العملاء المستهدفين: من هم، سلوكهم، حجم كل شريحة، قدرتهم الشرائية، واحتياجاتهم، بأرقام ومصادر حيثما أمكن.' },
    { title:'تحليل المنافسة', search:true, task:'تحليل المنافسين الفعليين (أسماء حقيقية) في جدول مقارنة (الحصة السوقية، التسعير، نقاط القوة والضعف)، وتحديد الفجوة والفرصة للمشروع.' },
    { title:'الطلب والتسعير', task:'تحليل الطلب على المنتج/الخدمة وحساسية السعر، وتوصية تسعير مبنية على السوق والمنافسة، في جدول.' },
    { title:'الفرص والتوصيات', task:'أهم الفرص السوقية غير المستغلة، وتوصيات استراتيجية عملية من منظور خبير (أين تلعب وكيف تكسب)، مرتّبة بالأولوية.' }
  ]
};
