...
var COMMON = '\n\n=== قواعد الجودة (إلزامية) ===\n' +
  ...
  '2) بيانات حقيقية: استخدم أداة البحث في الويب للحصول على إحصائيات حديثة وحقيقية عن السوق والقطاع في بلد المشروع (حجم السوق، معدلات النمو، سلوك المستهلك، المنافسين). اذكر المصدر واسم الجهة والسنة بين قوسين بعد كل رقم مهم. لا تخترع أرقاماً.\n' +
